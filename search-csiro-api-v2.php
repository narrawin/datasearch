...
//	---------------------------------------------------------------------------------
//	Open Data query utility for public data from CSIRO API (V2 - OpenAPI)
//	author:		C Bahlo
...
//
//			full doco at: 	https://data.csiro.au/dap/swagger-ui.html#!/Collection_Search/getCollectionsByLocationUsingGET
//	---------------------------------------------------------------------------------
...
?>
	...
	<title>CSIRO OpenAPI search tool</title>
...
?>
	<body>
	<div class="container">	
		<h2>CSIRO OpenAPI search tool</h2>
